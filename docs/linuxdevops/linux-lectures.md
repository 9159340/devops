...
Что добавлено в навигацию
Файл	Назначение
docs/linuxdevops/linux-lectures.md
15 кратких лекций
docs/linuxdevops/index.md
индекс раздела LinuxDevops
mkdocs.yml
пункты «Обзор», «Plan», «Лекции»
docs/index.md
ссылка на Linux DevOps (исправлена битая ссылка на linux/linux-plan-dim.md)
Содержание лекций
Каждая лекция — сжатый обзор (1–2 экрана): ключевые концепции, команды и файлы из чеклиста плана, без глубокого погружения. Темы 11–13 (namespaces, cgroups, ресурсы) связаны с контейнерами и Kubernetes, как в исходном плане.

Когда будете готовы разбить на отдельные файлы — скажите, могу написать скрипт, который по тегам TOPIC_START/TOPIC_END создаст 15 файлов и обновит mkdocs.yml.
ыы
---
